    ...
    return (
        <div className="mt-10 flex flex-col-reverse md:flex-row gap-14 justify-evenly items-center md:py-8 lg:py-16 md:px-16 lg:px-32">
            <div className="w-full flex justify-center">
                <img className="w-2/3" src="https://i.ibb.co.com/y5rJ929/pana.png" alt="" />
            </div>
            <div className="space-y-6 text-center md:text-left">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold">How to Submit Your Book Information</h1>
                ...
                <ul className="list-disc pl-5 text-gray-600 ml-5 text-left">
